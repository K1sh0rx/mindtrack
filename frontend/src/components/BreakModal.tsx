...
import { rescheduleApi, sessionApi } from "@/services/api";
    ...
    return (
      <div className="fixed inset-0 bg-background/95 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div className="text-center space-y-8">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-2">Take a breather</h2>
            <p className="text-muted-foreground">Relax, stretch, hydrate.</p>
          </div>
          <div className="font-mono text-6xl font-bold text-foreground text-glow">
            {formatTime(breakSeconds)}
          </div>
          <div className="flex gap-3 justify-center">
            <Button onClick={endBreak} className="bg-primary text-primary-foreground hover:bg-primary/90">
  ...
  return (
    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="glass rounded-2xl p-8 max-w-sm w-full text-center space-y-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-foreground mb-2">Feeling fatigued?</h2>
